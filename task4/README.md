...
在本次挑战中，我们将构建一个简单的 lamport 金库，展示如何使用基本账户、程序派生地址（PDA）和跨程序调用（CPI）。
...
- [参加挑战](https://learn.blueshift.gg/challenges/pinocchio-vault/verify)
- [查看源码](https://github.com/blueshift-gg/blueshift-dashboard/tree/master/src/app/content/challenges/pinocchio-vault/zh-CN/challenge.mdx)
